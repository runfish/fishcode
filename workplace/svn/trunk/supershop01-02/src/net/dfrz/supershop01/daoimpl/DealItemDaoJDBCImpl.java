...
public class DealItemDaoJDBCImpl implements DealItemDao {
	...
	/* (non-Javadoc)
	 * @see net.dfrz.supershop01.dao.dealItemDao#countdeal(net.dfrz.supershop01.servicesimpl.DealQuryHelper)
	 */
	...
	/* (non-Javadoc)
	 * @see net.dfrz.supershop01.dao.dealItemDao#getDealById(java.lang.Integer)
	 */
