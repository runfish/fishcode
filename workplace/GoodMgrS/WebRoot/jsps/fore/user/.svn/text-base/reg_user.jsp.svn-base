	   ...
	   function txtRepeatPass_check(){
		...
		function check(){
		   if(txtNickName_check()==false || 
			  txtPassword_check()==false || 
			  txtRepeatPass_check() ==false || 
			  txtRealName_check()==false || 
			  txtDate_check()==false || 
				     ...
				     <div>
				       <ul class=login_ul>
						 <li>
				      	 ...
				      	 <li>
				            <span class=span_n>密码：</span>
				            <input type="password"  id="userepwd" name="userepwd"
				            	class=input_text 
					            onblur="this.className='input_text';txtPassword_check()"
								onfocus="this.className='input_text input_text_over';check_password_focus();">
				            <p id=passwordValidMsg style="font-size:13px;"></p>
							<img class=notice_ok id=password_ok title=填写正确 src="<c:url value="/pic/write_ok.gif"/>">
				         </li>
				      	 <li>
				            ...
				            <input type="password"  id="userpwd1" name="userpwd1"
								class=input_text 
					            onblur="this.className='input_text';txtPassword_check()"
								onfocus="this.className='input_text input_text_over';check_repassword_focus()">
				            <p id=repeatPassValidMsg style="font-size:13px;"></p>
							<img class=notice_ok id=repassword_ok title=填写正确 src="<c:url value="/pic/write_ok.gif"/>">
				         </li>
				      	 <li>
				            <span class=span_n>真实姓名：</span>
				            <input type="text"  id="userrealname" name="userrealname"
								class=input_text 
					            onblur="this.className='input_text';txtRealName_check()"
								onfocus="this.className='input_text input_text_over';check_realname_focus()">
				            <p id=realNameValidMsg style="font-size:13px;"></p>
							<img class=notice_ok id=realname_ok title=填写正确 src="<c:url value="/pic/write_ok.gif"/>">
				         </li>
				         <li>
				            <span class=span_n>用户性别：</span>
				            <input type="radio" name="usersex" value="a" checked> 男
				            <input type="radio" name="usersex" value="b"> 女
				         </li>
				      	 <li>
