/**
 * Copyright (c) 2011-2012, James Zhan 瑭规尝 (jfinal@126.com).
 *
 ...
 */
public class C3p0PluginExt implements IPlugin, IDataSourceProvider {
	...
	public C3p0PluginExt setDriverClass(String driverClass) {
	...
	public C3p0PluginExt(String jdbcUrl, String user, String password) {
		this.jdbcUrl = jdbcUrl;
		this.user = user;
		this.password = password;
	}
	
	public C3p0PluginExt(String jdbcUrl, String user, String password, String driverClass) {
		this.jdbcUrl = jdbcUrl;
		this.user = user;
		this.password = password;
	...
	public C3p0PluginExt(String jdbcUrl, String user, String password, String driverClass, Integer maxPoolSize, Integer minPoolSize, Integer initialPoolSize, Integer maxIdleTime, Integer acquireIncrement) {
	...
	public C3p0PluginExt(File propertyfile) {
	...
	public C3p0PluginExt(File propertyfile,String jdbcUrl) {
		FileInputStream fis = null;
		try {
			fis = new FileInputStream(propertyfile);
			Properties ps = new Properties();
			...
			initC3p0Properties(jdbcUrl, ps.getProperty("user"), ps.getProperty("password"), ps.getProperty("driverClass"),
					toInt(ps.getProperty("maxPoolSize")), toInt(ps.getProperty("minPoolSize")), toInt(ps.getProperty("initialPoolSize")),
					toInt(ps.getProperty("maxIdleTime")),toInt(ps.getProperty("acquireIncrement")));
		} catch (Exception e) {
			e.printStackTrace();
	...
	public C3p0PluginExt(Properties properties) {
